...
public class PlayingSettingsPanel : MonoBehaviour
{
    ...
    [SerializeField] private Toggle         slowTurretToggle;
    ...
    void Populate()
    {
        ...
        if (slowTurretToggle) slowTurretToggle.SetIsOnWithoutNotify(_settings.SlowTurretEnabled);
    }
    ...
    void Subscribe()
    {
        ...
        if (slowTurretToggle) slowTurretToggle.onValueChanged.AddListener(OnSlowTurret);
    }
    ...
    void Unsubscribe()
    {
        ...
        if (slowTurretToggle) slowTurretToggle.onValueChanged.RemoveListener(OnSlowTurret);
    }
